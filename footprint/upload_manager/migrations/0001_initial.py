...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UploadTask'
        db.create_table(u'upload_manager_uploadtask', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('amigocloud_job', self.gf('django.db.models.fields.CharField')(max_length=36, unique=True, null=True, blank=True)),
            ('status', self.gf('django.db.models.fields.TextField')(default='PENDING')),
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='upload_tasks', to=orm['auth.User'])),
            ('config_entity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.ConfigEntity'], null=True)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('db_entity_id', self.gf('django.db.models.fields.IntegerField')(null=True)),
        ))
        db.send_create_signal(u'upload_manager', ['UploadTask'])

        # Adding model 'UploadDatasetTask'
        db.create_table(u'upload_manager_uploaddatasettask', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('amigocloud_job', self.gf('django.db.models.fields.CharField')(max_length=36, unique=True, null=True, blank=True)),
            ('status', self.gf('django.db.models.fields.TextField')(default='PENDING')),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ...
            ('extra', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('progress', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('upload_task', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['upload_manager.UploadTask'])),
            ('dataset_id', self.gf('django.db.models.fields.IntegerField')()),
            ('file_path', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('filename', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('_metadata', self.gf('django.db.models.fields.TextField')(null=True, db_column='metadata', blank=True)),
        ))
        db.send_create_signal(u'upload_manager', ['UploadDatasetTask'])


    def backwards(self, orm):
        # Deleting model 'UploadTask'
        db.delete_table(u'upload_manager_uploadtask')

        # Deleting model 'UploadDatasetTask'
        db.delete_table(u'upload_manager_uploaddatasettask')
    ...
    models = {
        ...
        u'upload_manager.uploaddatasettask': {
            ...
            'amigocloud_job': ('django.db.models.fields.CharField', [], {'max_length': '36', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
