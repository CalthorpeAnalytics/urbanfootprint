...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SwmmUpdaterTool'
        db.create_table(u'main_swmmupdatertool', (
        ...
        db.send_create_signal('main', ['SwmmUpdaterTool'])


    def backwards(self, orm):
        # Deleting model 'SwmmUpdaterTool'
        db.delete_table(u'main_swmmupdatertool')
    ...
    models = {
        ...
        'main.layerlibrary': {
            ...
            'layers': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'layer_libraries'", 'symmetrical': 'False', 'to': "orm['main.Layer']"}),
        ...
        'main.swmmupdatertool': {
            'Meta': {'object_name': 'SwmmUpdaterTool', '_ormbases': ['main.AnalysisTool']},
            u'analysistool_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['main.AnalysisTool']", 'unique': 'True', 'primary_key': 'True'})
        },
        'main.tag': {
