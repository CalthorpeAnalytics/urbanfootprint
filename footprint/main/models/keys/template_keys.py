...
class TemplateKeys(object):
    ...
    TEMPLATE_BUILT_FORMS_STANDARD_CSS = 'template_built_forms_leaflet_css'
    ...
    TEMPLATE_PRIMARY_BASE_LAND_USE_STANDARD_CSS = 'template_primary_base_land_use_leaflet_css'
    ...
    TEMPLATE_CENSUS_BLOCK_STANDARD_CSS = 'template_census_block_leaflet_css'
    ...
    TEMPLATE_CENSUS_BLOCKGROUP_STANDARD_CSS = 'template_census_blockgroup_leaflet_css'
