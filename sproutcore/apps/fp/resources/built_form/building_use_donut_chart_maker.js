...
d3.buildingUses.buildingUseDonutChart = function module() {

    var colors = {
        "single_family" : "#FFCC00",
        "townhome" : "#FF9900",
        "multifamily" : "#CC6600",
        "retail" : "#FF0000",
        "office" : "#CC0099",
     ...
     *
        ...
        the function d3.buildingUses.dataManager is helpful for creating these objects
     */
    ...
    function exports(_selection) {
        _selection.each(function(_data){
            ...
            var arcColors = d3.scale.ordinal()
                .domain(
                    ["Single Family", "Townhome", "Multifamily", "Retail", "Office", "Public", "Industrial",
                        "Agricultural", "Military"])
                .range([colors.single_family, colors.townhome, colors.multifamily, colors.retail, colors.office,
                    colors.public, colors.industrial, colors.agricultural, colors.military]);
...
d3.buildingUses.dataManager = function module() {
