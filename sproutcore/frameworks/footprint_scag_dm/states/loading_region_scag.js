...
/***
 * Loads controllers specific to scag_dm
 * @type {*}
 */
FootprintScagDm.LoadingRegionScagDmLandUseDefinitionState = Footprint.LoadingState.design({
...
FootprintScagDm.LoadingRegionScagDmState = SC.State.design({
   initialSubstate:'loadingRegionScagLandUseDefinitionState',
   loadingRegionScagLandUseDefinitionState: FootprintScagDm.LoadingRegionScagDmLandUseDefinitionState
});
